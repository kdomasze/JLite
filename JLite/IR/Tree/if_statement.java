...
public class if_statement extends block_statement
{
	...
	public void addIfStatement(String condition, String identifier, int literal, Vector block_list)
	{
	...
	public void addWhileStatement(String condition, String identifier, int literal, Vector block_list)
	{
	...
	public void addLocalVarDeclaration(type Type, String identifier, int literal, Vector block_list)
	{
	...
	public void addAssignment(String identifier, expression Expression, Vector block_list)
	{
	...
	public void addAdd(expression Expression, Vector block_list)
	{
	...
	public void addMultiply(expression Expression, Vector block_list)
	{
	...
	public void addSubtract(expression Expression, Vector block_list)
	{
	...
	public void addcreateObject(type Type, Vector block_list)
	{
